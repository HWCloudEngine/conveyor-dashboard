...
urlpatterns = patterns(
    ...
    url(r'^(?P<volume_id>[^/]+)/create_backup/$',
        ...
        name='create_backup'),
    url(r'^(?P<backup_id>[^/]+)/restore_backup/$',
        backup_views.RestoreBackupView.as_view(),
        name='restore_backup'),
    url(r'^(?P<volume_id>[^/]+)/$',
    ...
    url(r'^(?P<volume_id>[^/]+)/retype/$',
        ...
        name='retype'),
    url(r'^(?P<volume_id>[^/]+)/recover_volume$',
        views.RecoverVolumeView.as_view(), name='recover_volume'),
