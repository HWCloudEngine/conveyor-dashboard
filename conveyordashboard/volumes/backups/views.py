...
from conveyordashboard.volumes.backups \
...
class CreateBackupView(forms.ModalFormView):
    ...
    template_name = 'volumes/backups/create_backup.html'
    submit_label = _("Create Volume Backup")
    submit_url = "horizon:conveyor:volumes:volumes:create_backup"
    success_url = reverse_lazy("horizon:conveyor:volumes:backups_tab")
...
class BackupDetailView(tabs.TabView):
    ...
    template_name = 'volumes/backups/detail.html'
