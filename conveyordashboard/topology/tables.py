...
class CreateRule(CreateAction):
    ...
    def get_link_url(self, datum):
        LOG.info('secgroup_id %d',self.table.kwargs['secgroup_id'])
        LOG.info('create url: %s',reverse('horizon:conveyor:plans:add_rule', args=(self.table.kwargs['secgroup_id'],)))
        return reverse('horizon:conveyor:plans:add_rule', args=(self.table.kwargs['secgroup_id'],))
