...
ALLOW_MODIFY_STATUS = ('available', 'finished')
NOT_ALLOW_EXPORT_STATUS = ('expired', 'cloning', 'migrating', 'creating')
...
class PlansTable(tables.DataTable):
    ...
    class Meta(object):
        ...
        row_class = UpdateRow
        row_actions = (DeletePlan, ModifyPlan, ClonePlan, MigratePlan,
                       ExportPlan, CreateTrigger,)
