...
#
#     def get_data(self):
#         destination_azs = api.get_azs_of_plan_res(self.request,
#                                                   self.kwargs['plan_id'])
#         return destination_azs
#
#     @memoized.memoized_method
...
class DestinationView(forms.ModalFormView):
    ...
    def get_plan_res_azs(self, plan):
        try:
            plan_res_azs = api.get_plan_resource_availability_zones(
                self.request, plan)
